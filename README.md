...
![Paso 0](vpc-pasos/AWS-PROJECT.png) 
⚙ Tech Stack
...
5.  [Configure Application Load Balancer)](#configure-application-load-balancer)  
6. ⚙ [Create Launch Template for Auto Scaling Group (ASG)](#create-launch-template-for-auto-scaling-group-asg)  
   - Instance Type: t2.micro  
   - Custom AMI  
   - Associated Security Group  
7. 📈 [Create Auto Scaling Group (ASG)](#create-auto-scaling-group-asg)  
   - Minimum 1 instance  
   - Maximum 3 instances  
   - Associate with ELB  
...
Now, using the DNS name of our ALB, we can access the HTTP page hosted on our private instances. Since we previously configured the Security Group to allow HTTP traffic only from the ALB, this is the only valid path to reach the content.
